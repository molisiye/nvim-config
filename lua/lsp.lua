...
lsp_mapping.n["gr"] = { "<cmd>lua vim.diagnostic.open_float()<cr>", desc = "Hover diagnostic" }

lsp_mapping.n["gl"] = { "<cmd>lua vim.diagnostic.open_float()<CR>", desc = "" }
...
lsp_mapping.n["<leader>lj"] = { "<cmd>lua vim.diagnostic.goto_next({buffer=0})<cr>", desc = "" }
lsp_mapping.n["<leader>lk"] = { "<cmd>lua vim.diagnostic.goto_prev({buffer=0})<cr>", desc = "" }
lsp_mapping.n["<leader>lr"] = { "<cmd>lua vim.lsp.buf.rename()<cr>", desc = "Rename" }
lsp_mapping.n["<leader>ls"] = { "<cmd>lua vim.lsp.buf.signature_help()<CR>", desc = "" }
lsp_mapping.n["<leader>lq"] = { "<cmd>lua vim.diagnostic.setloclist()<CR>", desc = "" }
lsp_mapping.n["<leader>uh"] = { "<cmd>lua vim.lsp.inlay_hint(0,nil)<CR>", desc = "" }
